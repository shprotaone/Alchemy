...
namespace YG
{
    public class YandexGame : MonoBehaviour
    {
        ...
        #endregion PotionInBottle Fields
        ...
        #endregion Player PotionInBottle        
        ...
        #region GameProgressSaverHandler Leaderboard
        [DllImport("__Internal")]
        ...
        #endregion GameProgressSaverHandler Leaderboard
        ...
        #region Requesting Environment PotionInBottle
        [DllImport("__Internal")]
        ...
        #endregion Requesting Environment PotionInBottle
        ...
        public void SetLoadSaves(string data)
        {
            ...
            {
                savesData = cloudData;
                Message("Load Cloud Complete! Local PotionInBottle - " + localDataState);
                AfterLoading();
            }
            else if (localDataState == DataState.Exist)
            {
                savesData = localData;
                Message("Load Local Complete! Cloud PotionInBottle - " + cloudDataState);
                AfterLoading();
            }
                ...
                (cloudDataState == DataState.Broken && localDataState == DataState.Broken))
            {
                ...
                Message("Cloud Saves - Broken! PotionInBottle Recovering...");
                ResetSaveProgress();
            ...
            else if (localDataState == DataState.Broken)
            {
                ...
                Message("Local Saves - Broken! PotionInBottle Recovering...");
                ResetSaveProgress();
