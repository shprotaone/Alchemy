...
public class Shop : MonoBehaviour
{
    ...
    public void InitShop(Money money)
    {
        _currentMoney = money;
    ...
    {
        bool isCanBuy = _currentMoney.CurrentMoney >= value;
    ...
    //сделать блокировку и заполения магазина в зависимости от доступных ингредиентов
